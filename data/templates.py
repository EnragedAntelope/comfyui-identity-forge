...
COSTUME_SLOTS: dict[str, list[str]] = {
    ...
    # 80s neon activewear, sports-team colourways, and denim washes.
...
ARCHETYPES: dict[str, dict[str, str]] = {
    ...
    "1970s Boho It-Girl": {
        "gender": "Female", "ethnicity": "English", "body_type": "slim", "height": "average height",
        "hair_color": "golden blonde", "hair_length": "long", "hair_texture": "beachy waves",
    ...
    "1970s Leisure Lounge": {
        "gender": "Male", "ethnicity": "Italian", "body_type": "lean", "height": "tall",
        "facial_hair": "mustache", "hair_color": "dark brown", "hair_length": "ear length",
    ...
    "1940s Factory Worker": {
        "gender": "Female", "ethnicity": "English", "body_type": "fit", "height": "average height",
        "fitness_level": "moderately fit", "hair_color": "chestnut", "hair_length": "shoulder length",
    ...
    "1940s Swing Dancer": {
        "gender": "Male", "ethnicity": "Italian", "body_type": "lean", "height": "average height",
        "facial_hair": "clean shaven", "hair_color": "near black", "hair_length": "very short",
        "hair_texture": "sleek straight", "hair_style": "slicked back", "skin_tone": "light medium",
        "outfit_style": "vintage retro", "accessories": "no accessories",
    ...
    "Game-Day Fan": {
        ...
        "variants": {
            "Female": {
                ...
                "hair_color": "jet black", "hair_length": "long", "hair_texture": "kinky coily",
            ...
            "Male": {
                ...
                "fitness_level": "athletic", "facial_hair": "stubble", "hair_color": "dark brown",
    ...
    "Kawaii Street Fashion": {
        ...
        "variants": {
            "Female": {
                ...
                "hair_color": "baby pink", "hair_length": "long", "hair_texture": "softly curled",
            ...
            "Male": {
                ...
                "facial_hair": "clean shaven", "hair_color": "lavender", "hair_length": "ear length",
    ...
    "Classic Hollywood Starlet": {
        ...
        "hair_color": "platinum blonde", "hair_length": "shoulder length", "hair_texture": "loosely curled",
    ...
    "Classic Hollywood Leading Man": {
        "gender": "Male", "ethnicity": "Italian", "body_type": "athletic", "height": "tall",
        "facial_hair": "clean shaven", "hair_color": "jet black", "hair_length": "very short",
        "hair_texture": "sleek straight", "hair_style": "slicked back", "skin_tone": "light medium",
    ...
    "Backyard Country Casual": {
        ...
        "variants": {
            "Female": {
                ...
                "hair_color": "dirty blonde", "hair_length": "long", "hair_texture": "loosely wavy",
            ...
            "Male": {
                ...
                "facial_hair": "short beard", "hair_color": "medium brown", "hair_length": "very short",
    ...
    "1950s Suburban Dad": {
        ...
        "facial_hair": "clean shaven", "hair_color": "dark brown", "hair_length": "very short",
        "hair_texture": "sleek straight", "hair_style": "slicked back", "skin_tone": "light",
        "outfit_style": "smart casual", "accessories": "no accessories",
        "earrings": "no earrings", "necklace": "no necklace",
        "outfit_description": "a buttoned argyle sweater-vest over a collared dress shirt, pressed pleated slacks, a leather belt, and polished loafers",
    ...
    "1980s Aerobics": {
        ...
        "variants": {
            "Female": {
                ...
                "fitness_level": "athletic", "hair_color": "chestnut", "hair_length": "long",
            ...
            "Male": {
                "ethnicity": "English", "body_type": "athletic", "height": "tall",
                "fitness_level": "muscular", "facial_hair": "mustache", "hair_color": "dark brown",
    ...
    "Trucker": {
        ...
        "outfit_description": "a plaid flannel shirt worn open over a plain t-shirt, faded straight-leg jeans with a big belt buckle, scuffed leather work boots, and a mesh-back trucker cap",
        "expression": "relaxed", "location": "old-school greasy spoon", "lighting": "harsh fluorescent lighting",
        "shot_type": "medium shot from waist up", "mood": "lighthearted",
    },
    "Emo": {
        "body_type": "slim", "hair_color": "jet black", "hair_length": "shoulder length",
    ...
    "McBling Socialite": {
        ...
        "hair_color": "platinum blonde", "hair_length": "very long", "hair_texture": "pin straight",
        ...
        "outfit_description": "a velour tracksuit with a bedazzled logo, a cropped camisole, and oversized rhinestone sunglasses pushed up on the head",
        "expression": "confident", "location": "luxury retail boutique",
        "lighting": "high key bright even lighting", "shot_type": "full body shot", "mood": "carefree",
    },
    "Metrosexual": {
        "gender": "Male", "ethnicity": "Italian", "body_type": "fit", "height": "tall",
        "fitness_level": "very fit", "facial_hair": "stubble", "hair_color": "dark brown",
        ...
        "outfit_style": "smart casual", "accessories": "no accessories",
        "outfit_description": "a fitted designer button-down shirt with the top buttons open, slim tailored chinos, a sleek leather belt, and polished suede loafers",
        "expression": "confident", "location": "upscale urban cafe", "lighting": "soft window light from the side",
        "shot_type": "medium shot from waist up", "mood": "self-assured",
    },
    "Indie Sleaze": {
        "body_type": "lean", "hair_color": "near black", "hair_length": "shoulder length",
    ...
    "Y2K Mall Casual": {
        ...
        "variants": {
            "Female": {
                "ethnicity": "English", "body_type": "slim", "height": "average height",
                "hair_color": "medium brown", "hair_length": "long", "hair_texture": "pin straight",
            ...
            "Male": {
                ...
                "facial_hair": "soul patch", "hair_color": "dark blonde", "hair_length": "very short",
