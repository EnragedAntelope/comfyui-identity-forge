...
FIELD_DEFINITIONS: OrderedDict[str, dict] = OrderedDict([
    ...
    ("mood", {
        "group": 'Setting & Shot',
        "female_options": ['cheerful', 'melancholic', 'mysterious', 'confident', 'dreamy', 'tense', 'serene', 'playful', 'intense'],
        "male_options": ['cheerful', 'melancholic', 'mysterious', 'confident', 'dreamy', 'tense', 'serene', 'playful', 'intense'],
        "optional": False
    }),
    ("pose", {
        "group": 'Setting & Shot',
    ...
    ("location_setting", {
        "group": 'Setting & Shot',
        # Control toggle: filters the location pool to indoor / outdoor / either.
        "female_options": ['Any', 'Indoor', 'Outdoor'],
        "male_options": ['Any', 'Indoor', 'Outdoor'],
        "optional": False,
        "control": True
    }),
])
